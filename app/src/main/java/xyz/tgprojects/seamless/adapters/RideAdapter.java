...
public class RideAdapter extends RecyclerView.Adapter<RideAdapter.ViewHolder> implements View.OnClickListener{
    ...
    public void addRiders(String name, String des){
        mDataset.add(name);
        this.descr.add(des);
    }
    ...
    public RideAdapter(Context c, List<String>myDataset, List<String> descr, Picasso picasso) {
        mDataset = myDataset;
        this.descr = descr;
        this.c = c;
    ...
    @Override
    public RideAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                     int viewType) {
        // create a new view
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.distanceView.setText(descr.get(position));
